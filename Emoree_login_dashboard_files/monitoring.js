var amplilog = privacy.amplitude;
if(amplilog == 1){
	...
	try {
		amplitude.getInstance().init(location.host === 'www.emoree.de' ? 'cb9b8fad22ec0f8ba5dee31db9b3b585' : '7d2ff5c8ac9ab196673deec5eba4b6bd');
		$('a').on('click', function(){
			var click = $(this).text().replace(/[^a-zA-Z\d\s:]/i,"");
